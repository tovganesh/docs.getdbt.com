...
### Instrumentation
By default, the adapter will collect instumentation events to help improve functionality and understand bugs. If you want to specifically switch this off, for instance, in a production environement, you can explicitly set the flag `usage_tracking: false` in your `profiles.yml` file. 
